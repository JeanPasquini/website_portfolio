    ...
    $.fn.floatingWhatsApp = function (options) {
        ...
        function sendWhatsappMessage() {
            if (settings.message == "1"){
                settings.message = "Hello Jean, I would like to know more about your job."
            }else if(settings.message == "2"){
                settings.message = "Hello Jean, I would like to start using the Discord Bot."
            }else if(settings.message == "3"){
                settings.message = "Hello Jean, I would like help the community."
            }
            else{
